...
const CQ = (() => {
  ...
  const DICT = {
    en: {
      ...
      'cur.diff.current':'Currently in the knowledge base','cur.diff.proposed':'Proposed replacement','cur.diff.nochunk':'Current chunk unavailable — showing the proposed text only.','cur.proposed':'Proposed content',
      ...
      'bot.caps':'Rate caps','bot.cap.tenant':'Operator drafts / minute (whole workspace)','bot.cap.enduser':'Operator drafts / hour (one customer)',
      ...
      'cred.new':'New connection','cred.create':'Create connection','cred.created':'Connection created',
      'cred.empty':'No chat connections yet. Create one to let a chat service talk to this server.',
      'cred.loadfail':'Could not load the chat connections.','cred.unavailable':'Chat connections are not available on this server yet.',
      'cred.scopes':'Scopes','cred.workspaces':'Workspaces','cred.keys':'Keys',
      'cred.state.on':'Active','cred.state.off':'Deactivated',
      'cred.scope.turn':'ingest customer messages for operator drafts','cred.scope.suggest':'read drafts and stream them',
      'cred.scope.answer':'the public autopilot','cred.scope.sync':'mirror history and GDPR purge',
      'cred.name.ph':'e.g. Intercom bridge','cred.name.required':'Give the connection a name.','cred.scopes.required':'Pick at least one scope.',
      ...
      'cred.snippet.tenant':'workspace client_id','cred.snippet.same':'the same client_id',
      ...
      'cred.deactivate':'Deactivate','cred.deactivated':'Connection deactivated',
      ...
      'cred.grant.add':'Add workspace','cred.grant.title':'Grant a workspace to “{name}”','cred.grant.pick':'Workspace','cred.grant.submit':'Grant',
      'cred.grant.allgranted':'Every active workspace is already granted to this connection.',
      'cred.grant.added':'Workspace granted','cred.grant.remove':'Remove grant','cred.grant.removed':'Workspace grant removed',
      'cred.grant.remove.confirm':'Remove “{ws}” from “{name}”? The connection can no longer act for that workspace.',
      'cred.grant.none':'No workspaces yet','cred.keys.none':'No keys',
      'cred.key.created':'created','cred.key.lastused':'last used',
      'cred.key.revoked':'Revoked','cred.key.expired':'Expired','cred.key.expires':'Expires {when}',
      ...
      'ed.loading':'Reading the file…','ed.loaded':'Loaded “{name}”.',
      ...
      'ed.channel':'Channel','ed.selection':'Selection','ed.length':'Length',
      'ed.play':'Play','ed.pause':'Pause','ed.stop':'Stop','ed.fit':'Fit','ed.zoomsel':'Zoom to selection','ed.selectall':'Clear selection',
      'ed.undo':'Undo','ed.redo':'Redo',
      ...
      'ed.g.edit':'Edit','ed.cut':'Cut out selection','ed.trim':'Keep only selection','ed.silence':'Silence selection','ed.reverse':'Reverse',
      'ed.insert':'Insert silence (seconds)','ed.insert.go':'Insert',
      'ed.g.level':'Level','ed.normalize':'Normalise','ed.fadein':'Fade in','ed.fadeout':'Fade out','ed.invert':'Invert phase',
      ...
      'ed.g.channels':'Channels','ed.mono':'Mix to mono','ed.stereo':'Make stereo','ed.swap':'Swap left/right',
      'ed.ch.keep':'Keep only ch {n}','ed.ch.mute':'Mute ch {n}',
      ...
      'ed.g.export':'Export','ed.format':'Format',
      ...
      'ed.dl.wav':'Download WAV','ed.dl.convert':'Convert & download','ed.converting':'Converting…','ed.saved':'Saved.',
      'ed.fmt.unavailable':'Conversion unavailable','ed.err.convert':'The conversion failed.',
      ...
      'tn.th.source':'Source','tn.th.length':'Length','tn.th.who':'By','tn.who.unknown':'not recorded','tn.th.ran':'Analysed','tn.th.calls':'Calls','tn.th.summary':'Summary',
      'tn.src.audio':'Audio','tn.src.text':'Text',
      'tn.bands.heading':'Score colours','tn.bands.lead':'Where a score changes colour on the scorecard and on the timeline.','tn.bands.red':'Red','tn.bands.yellow':'Yellow','tn.bands.green':'Green','tn.bands.below':'below','tn.bands.upto':'up to','tn.bands.from':'from','tn.bands.andup':'and above','tn.bands.save':'Save colours','tn.bands.reset':'Reset colours to default','tn.bands.saved':'Score colours updated.','tn.sc.reset':'Reset to default','tn.sc.reset.heading':'Reset this rubric to the default?',
    ...
    ka: {
      ...
      'cur.diff.current':'ამჟამად ცოდნის ბაზაში','cur.diff.proposed':'შემოთავაზებული ჩანაცვლება','cur.diff.nochunk':'მიმდინარე ფრაგმენტი მიუწვდომელია — ნაჩვენებია მხოლოდ შემოთავაზებული ტექსტი.','cur.proposed':'შემოთავაზებული ტექსტი',
      ...
      'bot.caps':'სიხშირის ლიმიტები','bot.cap.tenant':'ოპერატორის მონახაზები / წუთში (მთელი სამუშაო სივრცე)','bot.cap.enduser':'ოპერატორის მონახაზები / საათში (ერთი კლიენტი)',
      ...
      'cred.new':'ახალი კავშირი','cred.create':'კავშირის შექმნა','cred.created':'კავშირი შეიქმნა',
      'cred.empty':'ჩატის კავშირები ჯერ არ არის. შექმენით ერთი, რომ ჩატის სერვისმა ამ სერვერთან მუშაობა შეძლოს.',
      'cred.loadfail':'ჩატის კავშირების ჩატვირთვა ვერ მოხერხდა.','cred.unavailable':'ჩატის კავშირები ამ სერვერზე ჯერ ხელმისაწვდომი არ არის.',
      'cred.scopes':'უფლებები','cred.workspaces':'სამუშაო სივრცეები','cred.keys':'გასაღებები',
      'cred.state.on':'აქტიური','cred.state.off':'გამორთული',
      'cred.scope.turn':'მომხმარებლის შეტყობინებების მიღება ოპერატორის მონახაზებისთვის','cred.scope.suggest':'მონახაზების წაკითხვა და ნაკადით მიწოდება',
      'cred.scope.answer':'საჯარო ავტოპილოტი','cred.scope.sync':'ისტორიის სარკისებური ასლი და GDPR-ის მიხედვით წაშლა',
      'cred.name.ph':'მაგ. Intercom-ის ხიდი','cred.name.required':'მიუთითეთ კავშირის სახელი.','cred.scopes.required':'აირჩიეთ მინიმუმ ერთი უფლება.',
      ...
      'cred.snippet.tenant':'სამუშაო სივრცის client_id','cred.snippet.same':'იგივე client_id',
      ...
      'cred.deactivate':'გამორთვა','cred.deactivated':'კავშირი გამორთულია',
      ...
      'cred.grant.add':'სამუშაო სივრცის დამატება','cred.grant.title':'წვდომის მიცემა „{name}“-ისთვის','cred.grant.pick':'სამუშაო სივრცე','cred.grant.submit':'წვდომის მიცემა',
      'cred.grant.allgranted':'ყველა აქტიურ სამუშაო სივრცეს ამ კავშირზე წვდომა უკვე აქვს.',
      'cred.grant.added':'სამუშაო სივრცეს წვდომა მიეცა','cred.grant.remove':'წვდომის მოხსნა','cred.grant.removed':'სამუშაო სივრცის წვდომა მოიხსნა',
      'cred.grant.remove.confirm':'მოვხსნა „{ws}“ „{name}“-იდან? კავშირი ამ სამუშაო სივრცის სახელით მოქმედებას ვეღარ შეძლებს.',
      'cred.grant.none':'სამუშაო სივრცეები ჯერ არ არის','cred.keys.none':'გასაღებები არ არის',
      'cred.key.created':'შეიქმნა','cred.key.lastused':'ბოლოს გამოყენებული',
      'cred.key.revoked':'გაუქმებული','cred.key.expired':'ვადაგასული','cred.key.expires':'ვადა იწურება {when}',
      ...
      'ed.loading':'ფაილი იკითხება…','ed.loaded':'ჩაიტვირთა „{name}“.',
      ...
      'ed.channel':'არხი','ed.selection':'მონიშნული','ed.length':'ხანგრძლივობა',
      'ed.play':'დაკვრა','ed.pause':'პაუზა','ed.stop':'გაჩერება','ed.fit':'მთლიანად','ed.zoomsel':'მონიშნულზე მიახლოება','ed.selectall':'მონიშვნის მოხსნა',
      'ed.undo':'დაბრუნება','ed.redo':'გამეორება',
      ...
      'ed.g.edit':'რედაქტირება','ed.cut':'მონიშნულის ამოჭრა','ed.trim':'მხოლოდ მონიშნულის დატოვება','ed.silence':'მონიშნულის დადუმება','ed.reverse':'უკუღმა',
      'ed.insert':'სიჩუმის ჩამატება (წამი)','ed.insert.go':'ჩამატება',
      'ed.g.level':'ხმის დონე','ed.normalize':'ნორმალიზება','ed.fadein':'თანდათან გაძლიერება','ed.fadeout':'თანდათან ჩაქრობა','ed.invert':'ფაზის ინვერსია',
      ...
      'ed.g.channels':'არხები','ed.mono':'მონოში გადაყვანა','ed.stereo':'სტერეოდ ქცევა','ed.swap':'მარცხენა/მარჯვენის შენაცვლება',
      'ed.ch.keep':'მხოლოდ {n} არხი','ed.ch.mute':'{n} არხის დადუმება',
      ...
      'ed.g.export':'ექსპორტი','ed.format':'ფორმატი',
      ...
      'ed.dl.wav':'WAV-ის ჩამოტვირთვა','ed.dl.convert':'გადაყვანა და ჩამოტვირთვა','ed.converting':'მიმდინარეობს გადაყვანა…','ed.saved':'შენახულია.',
      'ed.fmt.unavailable':'გადაყვანა მიუწვდომელია','ed.err.convert':'გადაყვანა ვერ შესრულდა.',
      ...
      'tn.th.source':'წყარო','tn.th.length':'ხანგრძლივობა','tn.th.who':'ვინ','tn.who.unknown':'არ არის ჩაწერილი','tn.th.ran':'გაანალიზებულია','tn.th.calls':'ზარები','tn.th.summary':'შეჯამება',
      'tn.src.audio':'აუდიო','tn.src.text':'ტექსტი',
      'tn.bands.heading':'ქულის ფერები','tn.bands.lead':'რომელ ზღვარზე იცვლება ქულის ფერი შეფასების ბარათსა და დროის ხაზზე.','tn.bands.red':'წითელი','tn.bands.yellow':'ყვითელი','tn.bands.green':'მწვანე','tn.bands.below':'ქვემოთ','tn.bands.upto':'—მდე','tn.bands.from':'-დან','tn.bands.andup':'და ზემოთ','tn.bands.save':'ფერების შენახვა','tn.bands.reset':'ფერების ნაგულისხმევზე დაბრუნება','tn.bands.saved':'ქულის ფერები განახლდა.','tn.sc.reset':'ნაგულისხმევზე დაბრუნება','tn.sc.reset.heading':'დაბრუნდეს რუბრიკა ნაგულისხმევზე?',
    ...
    ru: {
      ...
      'cur.diff.current':'Сейчас в базе знаний','cur.diff.proposed':'Предлагаемая замена','cur.diff.nochunk':'Текущий фрагмент недоступен — показан только предлагаемый текст.','cur.proposed':'Предлагаемый текст',
      ...
      'bot.caps':'Лимиты частоты','bot.cap.tenant':'Черновики для оператора / минуту (вся организация)','bot.cap.enduser':'Черновики для оператора / час (один клиент)',
      ...
      'cred.new':'Новое подключение','cred.create':'Создать подключение','cred.created':'Подключение создано',
      'cred.empty':'Подключений чата пока нет. Создайте одно, чтобы чат-сервис мог обращаться к этому серверу.',
      'cred.loadfail':'Не удалось загрузить подключения чата.','cred.unavailable':'Подключения чата пока недоступны на этом сервере.',
      'cred.scopes':'Права','cred.workspaces':'Организации','cred.keys':'Ключи',
      'cred.state.on':'Активно','cred.state.off':'Отключено',
      'cred.scope.turn':'приём сообщений клиентов для черновиков оператора','cred.scope.suggest':'чтение черновиков и их потоковая передача',
      'cred.scope.answer':'публичный автопилот','cred.scope.sync':'зеркалирование истории и удаление по GDPR',
      'cred.name.ph':'напр. мост Intercom','cred.name.required':'Укажите название подключения.','cred.scopes.required':'Выберите хотя бы одно право.',
      ...
      'cred.snippet.tenant':'client_id организации','cred.snippet.same':'тот же client_id',
      ...
      'cred.deactivate':'Отключить','cred.deactivated':'Подключение отключено',
      ...
      'cred.grant.add':'Добавить организацию','cred.grant.title':'Выдать доступ подключению «{name}»','cred.grant.pick':'Организация','cred.grant.submit':'Выдать доступ',
      'cred.grant.allgranted':'Всем активным организациям доступ к этому подключению уже выдан.',
      'cred.grant.added':'Доступ выдан','cred.grant.remove':'Отозвать доступ','cred.grant.removed':'Доступ отозван',
      'cred.grant.remove.confirm':'Отозвать доступ «{ws}» у «{name}»? Подключение больше не сможет действовать от имени этой организации.',
      'cred.grant.none':'Организаций пока нет','cred.keys.none':'Ключей нет',
      'cred.key.created':'создан','cred.key.lastused':'последнее использование',
      'cred.key.revoked':'Отозван','cred.key.expired':'Истёк','cred.key.expires':'Истекает {when}',
      ...
      'ed.loading':'Читаем файл…','ed.loaded':'Загружено «{name}».',
      ...
      'ed.channel':'Канал','ed.selection':'Выделение','ed.length':'Длительность',
      'ed.play':'Воспроизвести','ed.pause':'Пауза','ed.stop':'Стоп','ed.fit':'Целиком','ed.zoomsel':'К выделению','ed.selectall':'Снять выделение',
      'ed.undo':'Отменить','ed.redo':'Повторить',
      ...
      'ed.g.edit':'Правка','ed.cut':'Вырезать выделение','ed.trim':'Оставить только выделение','ed.silence':'Заглушить выделение','ed.reverse':'Реверс',
      'ed.insert':'Вставить тишину (секунды)','ed.insert.go':'Вставить',
      'ed.g.level':'Громкость','ed.normalize':'Нормализовать','ed.fadein':'Нарастание','ed.fadeout':'Затухание','ed.invert':'Инверсия фазы',
      ...
      'ed.g.channels':'Каналы','ed.mono':'Свести в моно','ed.stereo':'Сделать стерео','ed.swap':'Поменять левый/правый',
      'ed.ch.keep':'Оставить только канал {n}','ed.ch.mute':'Заглушить канал {n}',
      ...
      'ed.g.export':'Экспорт','ed.format':'Формат',
      ...
      'ed.dl.wav':'Скачать WAV','ed.dl.convert':'Сконвертировать и скачать','ed.converting':'Конвертируем…','ed.saved':'Сохранено.',
      'ed.fmt.unavailable':'Конвертация недоступна','ed.err.convert':'Не удалось сконвертировать.',
      ...
      'tn.th.source':'Источник','tn.th.length':'Длительность','tn.th.who':'Кто','tn.who.unknown':'не записано','tn.th.ran':'Проанализировано','tn.th.calls':'Звонки','tn.th.summary':'Сводка',
      'tn.src.audio':'Аудио','tn.src.text':'Текст',
      'tn.bands.heading':'Цвета оценок','tn.bands.lead':'Где меняется цвет оценки на карточке и на шкале времени.','tn.bands.red':'Красный','tn.bands.yellow':'Жёлтый','tn.bands.green':'Зелёный','tn.bands.below':'ниже','tn.bands.upto':'до','tn.bands.from':'от','tn.bands.andup':'и выше','tn.bands.save':'Сохранить цвета','tn.bands.reset':'Сбросить цвета','tn.bands.saved':'Цвета оценок обновлены.','tn.sc.reset':'Сбросить к умолчанию','tn.sc.reset.heading':'Сбросить рубрику к значению по умолчанию?',
