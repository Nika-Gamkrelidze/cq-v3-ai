...
const CQ = (() => {
  ...
  const DICT = {
    ...
    ka: {
      ...
      'kb.import':'ცოდნის იმპორტი','imp.file':'ფაილის ატვირთვა','imp.paste':'ტექსტის ჩასმა','imp.csv':'CSV (კითხვა-პასუხი / გასაღები-მნიშვნელობა)','kb.filelabel':'ფაილი (PDF / DOCX / XLSX / CSV / TXT / MD)','kb.csvlabel':'CSV ფაილი (პირველი სტრიქონი = სათაურები)','kb.searchlabel':'ცოდნის ბაზაში ძებნა','kb.search_ph':'დასვით კითხვა…','kb.documents':'დოკუმენტები','kb.none':'დოკუმენტები ჯერ არ არის. დაამატეთ ცოდნა ზემოთ.','kb.processing':'მუშავდება…','kb.nomatch':'შედეგი ვერ მოიძებნა.',
    ...
    ru: {
      ...
      'kb.import':'Импорт знаний','imp.file':'Загрузить файл','imp.paste':'Вставить текст','imp.csv':'CSV (вопрос-ответ)','kb.filelabel':'Файл (PDF / DOCX / XLSX / CSV / TXT / MD)','kb.csvlabel':'CSV-файл (первая строка = заголовок)','kb.searchlabel':'Поиск по базе знаний','kb.search_ph':'Задайте вопрос…','kb.documents':'Документы','kb.none':'Документов пока нет. Импортируйте знания выше.','kb.processing':'обработка…','kb.nomatch':'Совпадений нет.',
