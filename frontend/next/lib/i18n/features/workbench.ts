...
export const en: Dict = {
  ...
  'wb.all.partial': '{ok} of {total} checks finished, {err} failed',
  'wb.all.st.idle': 'Not run yet',
  'wb.all.st.wait': 'Waiting',
  'wb.all.st.run': 'Running',
  'wb.all.st.ok': 'Done',
  'wb.all.st.err': 'Failed',
  'wb.all.st.skip': 'Skipped',
  'wb.all.open': 'Open',
  'wb.all.h.factcheck': 'Accuracy against your knowledge base',
  'wb.all.h.semantic': 'Agent courtesy',
...
export const ka: Dict = {
  ...
  'wb.all.partial': '{total}-დან {ok} შემოწმება დასრულდა, {err} ვერ მოხერხდა',
  'wb.all.st.idle': 'ჯერ არ გაშვებულა',
  'wb.all.st.wait': 'რიგშია',
  'wb.all.st.run': 'მუშავდება',
  'wb.all.st.ok': 'მზადაა',
  'wb.all.st.err': 'ვერ მოხერხდა',
  'wb.all.st.skip': 'გამოტოვებულია',
  'wb.all.open': 'გახსნა',
  'wb.all.h.factcheck': 'სისწორე ცოდნის ბაზის მიხედვით',
  'wb.all.h.semantic': 'ოპერატორის ზრდილობა',
...
export const ru: Dict = {
  ...
  'wb.all.partial': 'Завершено {ok} из {total} проверок, с ошибкой: {err}',
  'wb.all.st.idle': 'Ещё не запускалось',
  'wb.all.st.wait': 'В очереди',
  'wb.all.st.run': 'Выполняется',
  'wb.all.st.ok': 'Готово',
  'wb.all.st.err': 'Ошибка',
  'wb.all.st.skip': 'Пропущено',
  'wb.all.open': 'Открыть',
  'wb.all.h.factcheck': 'Точность по базе знаний',
  'wb.all.h.semantic': 'Вежливость оператора',
