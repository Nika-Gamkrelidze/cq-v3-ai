...
@pytest.mark.parametrize("patch, needle", [
    ...
    ({"settings": {"answer_policy": "sometimes"}}, "answer_policy"),
    ({"settings": {"timezone": "Mars/Olympus"}}, "timezone"),
    ({"settings": {"opening_hours": {"mon": [{"open": "9am", "close": "18:00"}]}}},
     "opening_hours"),
    ({"settings": {"off_topic_warn_after": 5, "off_topic_cutoff_after": 5}},
     "off_topic_cutoff_after"),
    ({"settings": {"off_topic_warning": {"de": "Hallo"}}}, "off_topic_warning"),
    ({"settings": {"emergency_number": "call us"}}, "emergency_number"),
    ({"languages": []}, "languages"),
