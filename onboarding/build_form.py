...
KB_EXAMPLES = [
    ...
    ("როგორ დავბლოკო დაკარგული ბარათი?",
     ...
     "უსაფრთხოება", "ბოტისთვის დაშვებული"),
    ...
    ("რა ვადაში უნდა განიხილოს ოპერატორმა პრეტენზია?",
     ...
     "პრეტენზიები", "ბოტისთვის დაშვებული"),
...
def sheet_kb(wb):
    ...
    _note(ws, 4,
          "ხილვადობა: „ბოტისთვის დაშვებული“ — ბოტს შეუძლია ეს პასუხი კლიენტს "
          "სიტყვასიტყვით მოახსენოს. „შიდა“ — მხოლოდ თანამშრომლებისთვის (შიდა წესები, "
          "ფასდაკლების ლიმიტები, ესკალაციის პირობები). თუ ეჭვობთ — აირჩიეთ „შიდა“. "
          "ინტერნეტში არაფერი ქვეყნდება — მონაცემები თქვენს სამუშაო სივრცეში რჩება.", 4)
    ws.row_dimensions[4].height = 44

    head = 6
    _header_row(ws, head, KB_HEADERS, [42, 74, 16, 24])

    dv = DataValidation(type="list", formula1='"ბოტისთვის დაშვებული,შიდა"', allow_blank=True)
    dv.error = "აირჩიეთ „ბოტისთვის დაშვებული“ ან „შიდა“."
    dv.errorTitle = "არასწორი მნიშვნელობა"
    ws.add_data_validation(dv)
